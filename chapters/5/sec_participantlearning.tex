...
sliding window respectively. We utilize bootstrapping to generate normal theory 
confidence intervals for both the first and last sliding window, which confirms 
with $p < 0.05$ that there is a statistically significant difference in \tvt 
accuracy as the participants see more exposures.
